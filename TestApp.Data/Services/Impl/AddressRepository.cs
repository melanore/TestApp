...
namespace TestApp.Data.Services.Impl
{
    public class AddressRepository : IAddressRepository
    {
        ...
        public async Task<T> GetByCustomerIdAsync<T>(string customerId) where T: Address, new() =>
            await DbContext.Addresses.AsNoTracking().OfType<T>().SingleOrDefaultAsync(s => s.CustomerId == customerId);
        ...
        public void Delete(Address entity) => DbContext.Addresses.Remove(entity);
